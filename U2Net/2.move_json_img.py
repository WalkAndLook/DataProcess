...
path = r'./dataset/meter_crop/yibiao'  # 输入路径，包含原图和mask的_json文件夹
out_path = r'./dataset/meter_crop/yibiao_mask' # 输出路径，输出原图jpg和mask图png的文件夹，此时的label文件颜色为红色或者绿色，是可以看到的颜色
